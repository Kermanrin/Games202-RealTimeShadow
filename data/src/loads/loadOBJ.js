				...
				.load(name + '.obj', function (object) {
					object.traverse(function (child) {
						if (child.isMesh) {
							...
							let material, shadowMaterial, shadowMaterial1,shadowMaterial2;
							...
							let light2 = renderer.lights[2].entity;
							switch (objMaterial) {
								case 'PhongMaterial':
									material = buildPhongMaterial(colorMap, mat.specular.toArray(), light,light1, light2, Translation, Scale, "./src/shaders/phongShader/phongVertex.glsl", "./src/shaders/phongShader/phongFragment.glsl");
							...
							material.then((data) => {
								...
								renderer.mdict[meshname][1].push(renderer.meshes.length-1);
							});
							shadowMaterial.then((data) => {
								...
								renderer.mdict[meshname][2].push(renderer.shadowMeshes.length-1);
							});
